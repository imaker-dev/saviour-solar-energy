      ...
      <article className="relative h-full bg-white flex flex-col transition-all duration-500">
        ...
        <div className="relative aspect-[3/2] rounded-2xl overflow-hidden mb-6">
          ...
          <div className="absolute top-4 left-4">
            <span className="inline-flex items-center px-3 py-1.5 bg-white/95 backdrop-blur-sm text-slate-700 text-xs font-semibold tracking-wide rounded-full shadow-sm border border-white/40">
              {post.category.name}
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col flex-1">
          ...
          {/* Title */}
          <h3 className="text-xl font-medium text-slate-800 mb-3 line-clamp-2 group-hover:text-primary-500 transition-colors duration-300 leading-tight tracking-tight">
            {post.title}
          </h3>
